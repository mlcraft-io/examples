...
class SynmetrixSemanticLoader(BaseLoader):
    """Load `Synmetrix Semantic Layer` metadata.

    Args:
        synmetrix_load_api_url: REST API load data endpoint.
            Use the REST API of your Synmetrix's deployment.
        synmetrix_load_api_headers: Additional headers to be included in the request.
    ...
    def __init__(
        self,
        synmetrix_load_api_url: str,
        synmetrix_load_api_headers: dict = {},
        ...
        self.synmetrix_load_api_url = synmetrix_load_api_url
        self.synmetrix_load_api_headers = synmetrix_load_api_headers
    ...
    def _get_dimension_values(self, dimension_name: str) -> List[str]:
        ...
        headers = {
            ...
            **self.synmetrix_load_api_headers,
        }
        ...
        while retries < self.dimension_values_max_retries:
            response = requests.request(
                "POST",
                f"{self.synmetrix_load_api_url}/load",
                headers=headers,
    ...
    def load(self) -> List[Document]:
        ...
        logger.info(f"Loading metadata from {self.synmetrix_load_api_url}...")
        response = requests.get(f"{self.synmetrix_load_api_url}/meta", headers=headers)
